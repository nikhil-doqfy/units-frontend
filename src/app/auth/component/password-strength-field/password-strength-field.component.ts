...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, PasswordIconComponent, PasswordTooltipComponent, PasswordShowIconComponent, PasswordHideIconComponent],
...
export class PasswordStrengthFieldComponent {
  ...
  getStrengthClass(index: number): string {
    ...
    if (this.passwordStrength === 1) return index === 0 ? 'strength-bar red' : 'strength-bar';
    if (this.passwordStrength === 2) return index < 2 ? 'strength-bar yellow' : 'strength-bar';
    if (this.passwordStrength === 3) return index < 3 ? 'strength-bar yellow' : 'strength-bar';
