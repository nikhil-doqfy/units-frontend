...
import { CardIconComponent } from '../../component/icons/card-icon/card-icon.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, WhiteCardComponent, PaypalIconComponent, DashFormComponent, CardIconComponent, PlusIconComponent, MinusIconComponent],
...
export class PayMyDuesComponent {
  ...
  paymentMethodView: 'credit-Debit-card' | 'NEFT-bank-transfer' | 'PayPal' = 'credit-Debit-card';
  quantity: number = 1;
