...
@Component({
  selector: 'app-pmc',
  standalone: true,
  imports: [CommonModule, TableTitleComponent, TableSelectComponent, TableSearchComponent, TableFilterButtonComponent, ExportIconComponent, InvitePMCButtonComponent, TableActionButtonComponent, TableActionDropdownComponent, TablePaginationComponent, SendIconComponent, AssignPropertyFormComponent, TableViewCardComponent, WhiteCardComponent, FilterIconComponent, DocumentTypeItemComponent, SortingIconComponent, TableImgItemComponent],
...
export class PMCComponent {
  ...
  openAssignPropertyModal(assignPropertyContent: TemplateRef<any>) {
    this.modalService.open(assignPropertyContent, { ariaLabelledBy: 'modal-title', windowClass: 'mdlCommon mdlSmall', centered: true }).result.then(
      (result) => {
