...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, WhiteCardComponent, CardTitleComponent, TableTitleComponent, TableActionButtonComponent, SortingIconComponent, TableSelectComponent, PlusIconComponent, BackIconComponent, TablePaginationComponent, AddRoleFormComponent],
...
export class RolesAndPermissionsComponent {
  ...
  openAddRoleModal(addRoleContent: TemplateRef<any>) {
    this.modalService.open(addRoleContent, { ariaLabelledBy: 'modal-title', windowClass: 'mdlCommon mdlSmall', centered: true }).result.then(
      (result) => {
