...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, PlusIconComponent, RefreshIconComponent, TableTitleComponent, TableImgItemComponent, BadgeComponent, TableSelectComponent, TableSearchComponent, TableFilterButtonComponent, FilterIconComponent, CustomSelectComponent, ExportIconComponent, TableActionButtonComponent, TableActionDropdownComponent, TablePaginationComponent, SortingIconComponent, WhiteCardComponent, DocumentTypeItemComponent, PropertyViewCardComponent, CardTitleComponent, DashTitleComponent],
  ...
  property = {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { label: "Rent Cost", value: "AED31,224" },
        ]
      },
      {
